...
- [~] `DX08` [Medium] Milstein now supports control-aware Jacobian-product interfaces, user-injected autodiff/JVP-style callbacks, stronger finite-difference fallbacks for non-scalar controls, and Stratonovich-Milstein JVP-wrapper regression coverage; full autodiff parity remains pending.
